...
ZEPHIR_INIT_CLASS(GeoIP2_MaxMind_Db_Reader_Metadata) {
	...
	ZEPHIR_REGISTER_CLASS(GeoIP2\\MaxMind\\Db\\Reader, Metadata, geoip2, maxmind_db_reader_metadata, geoip2_maxmind_db_reader_metadata_method_entry, 0);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("binaryFormatMajorVersion"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("binaryFormatMinorVersion"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("buildEpoch"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("databaseType"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("description"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("ipVersion"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("languages"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("nodeByteSize"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("nodeCount"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("recordSize"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(geoip2_maxmind_db_reader_metadata_ce, SL("searchTreeSize"), ZEND_ACC_PRIVATE TSRMLS_CC);
...
PHP_METHOD(GeoIP2_MaxMind_Db_Reader_Metadata, __construct) {
	...
	zephir_array_fetch_string(&_0, metadata, SL("binary_format_major_version"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 66 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("binaryFormatMajorVersion"), &_0);
	zephir_array_fetch_string(&_1, metadata, SL("binary_format_minor_version"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 68 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("binaryFormatMinorVersion"), &_1);
	zephir_array_fetch_string(&_2, metadata, SL("build_epoch"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 69 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("buildEpoch"), &_2);
	zephir_array_fetch_string(&_3, metadata, SL("database_type"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 70 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("databaseType"), &_3);
	zephir_array_fetch_string(&_4, metadata, SL("languages"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 71 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("languages"), &_4);
	zephir_array_fetch_string(&_5, metadata, SL("description"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 72 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("description"), &_5);
	zephir_array_fetch_string(&_6, metadata, SL("ip_version"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 73 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("ipVersion"), &_6);
	zephir_array_fetch_string(&_7, metadata, SL("node_count"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 74 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("nodeCount"), &_7);
	zephir_array_fetch_string(&_8, metadata, SL("record_size"), PH_NOISY | PH_READONLY, "geoip2/MaxMind/Db/Reader/Metadata.zep", 75 TSRMLS_CC);
...
PHP_METHOD(GeoIP2_MaxMind_Db_Reader_Metadata, __toArray) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("get_object_vars", NULL, 69, this_ptr);
