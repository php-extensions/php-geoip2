 ...
 * services and databases.
 */
ZEPHIR_INIT_CLASS(GeoIP2_Record_Continent) {

	ZEPHIR_REGISTER_CLASS_EX(GeoIP2\\Record, Continent, geoip2, record_continent, geoip2_record_abstractplacerecord_ce, NULL, 0);

	/**
	 * @ignore
	 */
	zend_declare_property_null(geoip2_record_continent_ce, SL("validAttributes"), ZEND_ACC_PROTECTED TSRMLS_CC);

	geoip2_record_continent_ce->create_object = zephir_init_properties_GeoIP2_Record_Continent;
	return SUCCESS;

}

zend_object *zephir_init_properties_GeoIP2_Record_Continent(zend_class_entry *class_type TSRMLS_DC) {
